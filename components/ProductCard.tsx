  ...
  return (
    <div className="bg-[#1e1e24] border border-white/10 rounded-xl p-6 mb-8 flex flex-col md:flex-row gap-6 shadow-2xl shadow-black/50">
      ...
      <div className="flex flex-col justify-center w-full">
        <div className="uppercase tracking-widest text-xs text-purple-400 font-bold mb-2">Phase 1 — 分析報告</div>
        <h2 className="text-3xl font-bold text-white serif mb-1">{analysis.name}</h2>
        <p className="text-gray-400 text-sm mb-2 italic">{analysis.visualDescription}</p>
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-semibold text-white/80 uppercase tracking-wider border-b border-white/10 pb-1 inline-block">核心特色</h3>
          <p className="text-gray-300 leading-relaxed">{analysis.keyFeaturesZh}</p>
        </div>
      </div>
    </div>
  );
